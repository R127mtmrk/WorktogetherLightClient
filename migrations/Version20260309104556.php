 ...
 */
final class Version20260309104556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer CHANGE price discount_percent NUMERIC(10, 2) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer CHANGE discount_percent price NUMERIC(10, 2) DEFAULT NULL');
