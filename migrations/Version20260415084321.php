 ...
 */
final class Version20260415084321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, name_offer VARCHAR(255) NOT NULL, discount_percent NUMERIC(10, 2) DEFAULT NULL, min_units INT DEFAULT NULL, max_units INT DEFAULT NULL, is_active TINYINT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, quantity INT NOT NULL, unit_price NUMERIC(10, 2) NOT NULL, annual_payment TINYINT NOT NULL, discount_percent NUMERIC(10, 2) DEFAULT NULL, total NUMERIC(10, 2) NOT NULL, created_at DATETIME NOT NULL, client_id INT NOT NULL, offer_id INT DEFAULT NULL, INDEX IDX_F529939819EB6921 (client_id), INDEX IDX_F529939853C674EE (offer_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE unit (id INT AUTO_INCREMENT NOT NULL, is_free TINYINT NOT NULL, order_id INT DEFAULT NULL, ticket_id INT DEFAULT NULL, bay_id INT NOT NULL, state_id INT NOT NULL, INDEX IDX_DCBB0C538D9F6D38 (order_id), INDEX IDX_DCBB0C53700047D2 (ticket_id), INDEX IDX_DCBB0C53DF9BA23B (bay_id), INDEX IDX_DCBB0C535D83CC1 (state_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, pwd_err DOUBLE PRECISION NOT NULL, token VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, is_business TINYINT DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
