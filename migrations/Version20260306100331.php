 ...
 */
final class Version20260306100331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer ADD name_offer VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE `order` CHANGE discount_percent discount_percent NUMERIC(10, 2) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer DROP name_offer');
        $this->addSql('ALTER TABLE `order` DROP FOREIGN KEY FK_F529939819EB6921');
        $this->addSql('ALTER TABLE `order` DROP FOREIGN KEY FK_F529939853C674EE');
        $this->addSql('ALTER TABLE `order` CHANGE discount_percent discount_percent NUMERIC(10, 2) NOT NULL');
